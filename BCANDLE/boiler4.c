...
#define N_CLOCKS 11
static short clock_max_bound[N_CLOCKS] = {0, 0, 63, 225, 10, 6, 205, 30, 30, 6, 1100};
/********************** DBMS **************************************/
/******************** Bounds ********************************************/
#include <values.h>
...
typedef enum {_CHAN_k_MID_start=0, _CHAN_k_MID_temperature=1} _CHAN_k_MID_t;
